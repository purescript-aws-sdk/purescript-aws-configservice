...
``` purescript
deleteConfigRule :: forall eff. Service -> DeleteConfigRuleRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
deleteConfigurationRecorder :: forall eff. Service -> DeleteConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
deleteDeliveryChannel :: forall eff. Service -> DeleteDeliveryChannelRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
putConfigRule :: forall eff. Service -> PutConfigRuleRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
putConfigurationRecorder :: forall eff. Service -> PutConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
putDeliveryChannel :: forall eff. Service -> PutDeliveryChannelRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
startConfigurationRecorder :: forall eff. Service -> StartConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
stopConfigurationRecorder :: forall eff. Service -> StopConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
