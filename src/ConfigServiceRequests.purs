...
deleteConfigRule :: forall eff. ConfigService.Service -> ConfigServiceTypes.DeleteConfigRuleRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deleteConfigurationRecorder :: forall eff. ConfigService.Service -> ConfigServiceTypes.DeleteConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deleteDeliveryChannel :: forall eff. ConfigService.Service -> ConfigServiceTypes.DeleteDeliveryChannelRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
getComplianceSummaryByConfigRule (ConfigService.Service serviceImpl) = AWS.request serviceImpl method (Types.NoInput unit) where
...
putConfigRule :: forall eff. ConfigService.Service -> ConfigServiceTypes.PutConfigRuleRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
putConfigurationRecorder :: forall eff. ConfigService.Service -> ConfigServiceTypes.PutConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
putDeliveryChannel :: forall eff. ConfigService.Service -> ConfigServiceTypes.PutDeliveryChannelRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
startConfigurationRecorder :: forall eff. ConfigService.Service -> ConfigServiceTypes.StartConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
stopConfigurationRecorder :: forall eff. ConfigService.Service -> ConfigServiceTypes.StopConfigurationRecorderRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
